...
class FieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post fields_url, params: { field: { address: @field.address, height: @field.height, name: @field.name, width: @field.width } }
    end
  ...
  test "should update field" do
    patch field_url(@field), params: { field: { address: @field.address, height: @field.height, name: @field.name, width: @field.width } }
